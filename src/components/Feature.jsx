...
import {explore1Img, explore2Img} from "../utils/index.js";
            ...
            <div className={"screen-max-width"}>
                ...
                <div className={"flex flex-col justify-center items-center overflow-hidden"}>
                    <div className={"mt-32 mb-24 pl-24"}>
                        <h2 className={"text-5xl lg:text-7xl font-semibold mb-2"}>Iphone.</h2>
                        <h2 className={"text-5xl lg:text-7xl font-semibold"}>Forged in titanium.</h2>
                    </div>
                    <div className={"flex-center flex-col sm:px-10"}>
                        <div className={"relative h-[50vh] w-full flex items-center"}>
                            <video playsInline id={"exploreVideo"}
                            className={"w-full h-full object-cover object-center"} preload={"none"} muted
